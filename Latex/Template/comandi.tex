...
\newcommand{\lvlii}[1]{\section{#1}}
\newcommand{\lvliii}[1]{\subsection{#1}}
\newcommand{\lvliv}[1]{\subsubsection{#1}}
\newcommand{\lvlv}[1]{\paragraph{#1}\mbox{}\\}
\newcommand{\lvlvi}[1]{\subparagraph{#1}}
...
\newcommand{\imgtwo}[2] {
  \begin{figure}[H]
    \centering
    \includegraphics[width=100mm]{img/#1}
    \caption{#2}
    \label{fig:#1}
  \end{figure}
}
