...
This test wants to see the ability of the PIDKPA101 controller to counter drift and high frequency fluctuations.
...
Another way to see the advantage is to represent the two signals as xy-coordinates in the sensor as shown in \fig{measure/PID_on_off} where zero represents the target position. In this figure it can be clearly seen that  the fluctuations with the controller active represented by \textit{the blue square}, are more centered in the target and fluctuate less respect with the others with the controller disabled represented by the \textit{red oval}.
...
As shown from \fig{measure/PID_on_off} the drift was compensated by moving the centroid from (21.34, -3.68) to (-0.75, 2.89) pixels, while fluctuations have worsened as seen by comparing the second-order centered moment from (10.04, 8.41) to (8.62, 29.67) pixels.
...
% \lvliii{One shot r10/r30}
% \img{measure/OneShot_r30}{OneShot r30.}
% \img{measure/OneShot_r10}{OneShot r10.}
% \img{measure/OneShot_r10_r30}{OneShot r10 and r30.}
% % TODO: corregge dript, peggiorano le frequenze, (xk controllore ad alte freq ha gossi errori), riferimento alla calibrazione, stessi numeri


\lvlii{Test of the PATF and PATC}
