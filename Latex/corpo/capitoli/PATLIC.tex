...
\lvlii{Setup}
\img{PATLIC/setup-ottico}{PATLIC optical setup.}
...
% The alignment procedure will be reported in this section, to simplify it will be defined acronyms of the main components in Tab. \ref{table:1}.
