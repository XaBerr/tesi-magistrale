...
\lvliii{PID on/off con stufetta}
\img{measure/PID_off}{PID off.}
\img{measure/PID_on}{PID on.}
\img{measure/PID_on_off}{PID on and off.}
...
% TODO: PIDKPA101 corregge dript e frequenze, quadrato, metto i numeri (mean, sqrt(var)) e ratio delle varianze
