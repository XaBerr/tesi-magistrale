...
In this experiment there is a trasmitter (Alice) and a receiver (Bob). As shown in \fig{PATLIC/setup-ottico} they use a PATF's beam (blue) at 1064nm and two PATC's beams (red) at 850nm, to inject a 1550nm signal SIG's beam (yellow) into a single-mode fiber.
