...
\lvlii{Logical setup}
\img{PATLIC/setup-ottico}{PATLIC logical setup. The acronyms are: wavelength division multiplexing (WDM), dichroic mirror (DM), beam expander (beam exp), and beam reducer (beam red).}
