...
\imgs{0.4}{pictures/ui}{Typica user interface for data analysis.}
...
Fixed a ratio (voltage) of movement, the ratio between pixel and time will result in a perfect line in case of ideality of the system. Unfortunately the system is not ideal and therefore a fit of the points obtained is required as shown in \fig{calibrazione}.
...
This calibration procedure is typically broken into two parts because when you create a system you do not know which are the best ratios (voltages) and therefore must be searched.
...
\img{calibrazione}{Example of data acquisition for the PATF done with mirror-camera-pc configuration.}
