...
\lvlii{Components}
In questa sezione verranno elencati i componenti utilizzati nel sistema PAT.
\lvliii{Sensors}
\lvliv{Camera}
CMOS
Lavora in px
Meglio nelle lunghe distanze perché integra

\lvliv{PSD}
Lavora in volt x, y, sum
Necessita di un driver come il KPA101
Meglio nelle corte distanze
