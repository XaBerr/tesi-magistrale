...
The industrial \idx{camera} is the main sensor for communication. Depending on the model it can cover all the spectra useful for communication with lasers: ultraviolet, visible, infrared.
...
\img{PAT-coarse}{PATC model-implementation system.}
...
\lvliii{Logical design}
\img{PAT-fine-v1}{PATF model-implementation system with position sensitive device.}
\img{PAT-fine-v2}{PATF model-implementation system with camera.}
