...
\lvlii{Coarse}
\img{PAT-coarse}{PATC models' implementation.}
...
\lvlii{Fine}
\img{PAT-fine-v1}{PATF models' implementation with position sensitive device.}
\img{PAT-fine-v2}{PATF models' implementation with camera.}
